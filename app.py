...
lineaccesstoken = 'lPj6/eZOnZw+BEL7Sgps0klpST4NtfuXvweToiabvpHCaOitgsyVSVL3la8s0qIN+aJ/Pqtl5snzZh0fvcch7TMSDjRUgjkbejmc4Vlr2PenhGFMiJGJdPPvAK9uuF/TnjNmHwgpB4aQ47UdC8emEgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            ...
            replyObj = TextSendMessage(text="ไม่หล่ะชอบก๋วยเตี๋ยวมากกว่า")
        elif msg == "ชอบประเทศอะไร":
            replyObj = TextSendMessage(text="USA กับ JAPANหน่ะ")
        else : TextSendMessage(text=msg) 
        line_bot_api.reply_message(rtoken, replyObj)
    elif msgType == "image":
        try:
